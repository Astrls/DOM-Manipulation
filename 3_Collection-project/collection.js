...
ICONS:
    ...
    indirect: <i class="fa-solid fa-sun-cloud"></i>
    shade: <i class="fa-solid fa-clouds"></i>
...
const PLANTS = [
  {
    ...
    light: `<i class="fa-solid fa-sun-cloud"></i>`,
  ...
  },
  {
    ...
    light: `<i class="fa-solid fa-sun"></i><i class="fa-solid fa-sun-cloud"></i>`,
